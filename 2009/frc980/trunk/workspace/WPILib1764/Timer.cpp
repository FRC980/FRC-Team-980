 ...
 * 
 * Pause the execution of the program for a specified period of time given
 * in seconds.  Motors will continue to run at their last assigned values,
 * and sensors will continue to update. Only the task containing the wait
 * will pause until the wait time is expired.
 * 
 ...
 * @return The time, just in case you want the robot to start autonomous
 * at 8pm on Saturday.
*/
double GetTime(void)  
{
 ...
 * timer class. If the clock is not running, then return the time when it
 * was last stopped.
 * 
