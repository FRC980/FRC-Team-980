...
struct HitNode
{
    ...
    void printNode()
    {
        DPRINTF(LOG_DEBUG, "~!~ index=%i ~!~ nodeArea=%g ", nodeIndex,
                nodeArea);
    }
};
struct HitList
                        ...
                        Rect rect, int numberHitsRequested)
{
    ...
    // fill in return structure - indices of largest hits
...
* @param numberHits number of particles to request of each color
* @return 0 = error
*/
            ...
            case ABOVE:        //is second color above first color?
                    ...
                    firstTrackReport->center_mass_y)
                {
                                         ...
                                         secondTrackReport->particleArea))
                    {
                        ...
                        memcpy(trackReport, firstTrackReport,
