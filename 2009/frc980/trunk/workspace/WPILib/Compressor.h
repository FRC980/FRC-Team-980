...
/**
 * Compressor object.
 * The Compressor object is designed to handle the operation of the
 * compressor, pressure sensor and relay for a FIRST robot pneumatics
 * system. The Compressor object starts a task which runs in the backround
 * and periodically polls the pressure sensor and operates the relay that
...
class Compressor : public SensorBase
{
  ...
  private:
    void InitCompressor(UINT32 pressureSwitchSlot,
