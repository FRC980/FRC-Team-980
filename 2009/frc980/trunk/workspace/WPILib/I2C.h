 ...
 *
 * This class is intended to be used by sensor (and other I2C device)
 * drivers.  It probably should not be used directly.
 *
...
class I2C:SensorBase
{
  ...
  public:
    ...
    bool VerifySensor(UINT8 registerAddress, UINT8 count,
