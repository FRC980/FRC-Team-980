 ...
 * The Resource class is a convienent way of keeping track of allocated
 ...
 * library they are used for tracking allocation of hardware channels but
 * this is purely arbitrary. The resource class does not do any actual
