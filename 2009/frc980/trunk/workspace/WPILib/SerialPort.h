 ...
 *
 * The current implementation uses the VISA formatted I/O mode.  This
 * means that all traffic goes through the fomatted buffers.  This allows
 * the intermingled use of Printf(), Scanf(), and the raw buffer accessors
 * Read() and Write().
 *
