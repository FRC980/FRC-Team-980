    ...
    namespace n306F586FB5ADD059CDB0429821CA506D
    {
        class tSPI:public tSystem
        {
          public:
            ...
            static void writeConfig_BusBitWidth(unsigned char value,
                                                tRioStatusCode * status);
            static void writeConfig_ClockHalfPeriodDelay(unsigned char
                                                         value,
                                                         tRioStatusCode *
                                                         status);
            static void writeConfig_MSBfirst(bool value,
                                             tRioStatusCode * status);
            static void writeConfig_DataOnFalling(bool value,
                                                  tRioStatusCode * status);
            static void writeConfig_LatchFirst(bool value,
                                               tRioStatusCode * status);
            static void writeConfig_LatchLast(bool value,
                                              tRioStatusCode * status);
            static void writeConfig_FramePolarity(bool value,
                                                  tRioStatusCode * status);
            static void writeConfig_WriteOnly(bool value,
                                              tRioStatusCode * status);
            static tConfig readConfig(tRioStatusCode * status);
            static unsigned char readConfig_BusBitWidth(tRioStatusCode *
                                                        status);
            static unsigned char
                readConfig_ClockHalfPeriodDelay(tRioStatusCode * status);
            ...
            static void writeDataToLoad(unsigned int value,
                                        tRioStatusCode * status);
            static unsigned int readDataToLoad(tRioStatusCode * status);

            static unsigned short readAvaliableToLoad(tRioStatusCode *
                                                      status);

            static unsigned int readReceivedData(tRioStatusCode * status);

            static void writeChannels(tChannels value,
                                      tRioStatusCode * status);
            static void writeChannels_SCLK_Channel(unsigned char value,
                                                   tRioStatusCode * status);
            static void writeChannels_SCLK_Module(unsigned char value,
                                                  tRioStatusCode * status);
            static void writeChannels_MOSI_Channel(unsigned char value,
                                                   tRioStatusCode * status);
            static void writeChannels_MOSI_Module(unsigned char value,
                                                  tRioStatusCode * status);
            static void writeChannels_MISO_Channel(unsigned char value,
                                                   tRioStatusCode * status);
            static void writeChannels_MISO_Module(unsigned char value,
                                                  tRioStatusCode * status);
            static void writeChannels_SS_Channel(unsigned char value,
                                                 tRioStatusCode * status);
            static void writeChannels_SS_Module(unsigned char value,
                                                tRioStatusCode * status);
            static tChannels readChannels(tRioStatusCode * status);
            static unsigned char readChannels_SCLK_Channel(tRioStatusCode *
                                                           status);
            static unsigned char readChannels_SCLK_Module(tRioStatusCode *
                                                          status);
            static unsigned char readChannels_MOSI_Channel(tRioStatusCode *
                                                           status);
            static unsigned char readChannels_MOSI_Module(tRioStatusCode *
                                                          status);
            static unsigned char readChannels_MISO_Channel(tRioStatusCode *
                                                           status);
            static unsigned char readChannels_MISO_Module(tRioStatusCode *
                                                          status);
            static unsigned char readChannels_SS_Channel(tRioStatusCode *
                                                         status);
            static unsigned char readChannels_SS_Module(tRioStatusCode *
                                                        status);

            static void strobeLoad(tRioStatusCode * status);

            static unsigned short readReceivedElements(tRioStatusCode *
                                                       status);
