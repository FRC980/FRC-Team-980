    ...
    namespace n306F586FB5ADD059CDB0429821CA506D
    {
        class tCounter:public tSystem
        {
          public:
            ...
            void writeConfig_UpSource_Channel(unsigned char value,
                                              tRioStatusCode * status);
            void writeConfig_UpSource_Module(unsigned char value,
                                             tRioStatusCode * status);
            void writeConfig_UpSource_AnalogTrigger(bool value,
                                                    tRioStatusCode *
                                                    status);
            void writeConfig_DownSource_Channel(unsigned char value,
                                                tRioStatusCode * status);
            void writeConfig_DownSource_Module(unsigned char value,
                                               tRioStatusCode * status);
            void writeConfig_DownSource_AnalogTrigger(bool value,
                                                      tRioStatusCode *
                                                      status);
            void writeConfig_IndexSource_Channel(unsigned char value,
                                                 tRioStatusCode * status);
            void writeConfig_IndexSource_Module(unsigned char value,
                                                tRioStatusCode * status);
            void writeConfig_IndexSource_AnalogTrigger(bool value,
                                                       tRioStatusCode *
                                                       status);
            void writeConfig_IndexActiveHigh(bool value,
                                             tRioStatusCode * status);
            void writeConfig_UpRisingEdge(bool value,
                                          tRioStatusCode * status);
            void writeConfig_UpFallingEdge(bool value,
                                           tRioStatusCode * status);
            void writeConfig_DownRisingEdge(bool value,
                                            tRioStatusCode * status);
            void writeConfig_DownFallingEdge(bool value,
                                             tRioStatusCode * status);
            void writeConfig_Mode(unsigned char value,
                                  tRioStatusCode * status);
            void writeConfig_PulseLengthThreshold(unsigned short value,
                                                  tRioStatusCode * status);
            tConfig readConfig(tRioStatusCode * status);
            unsigned char readConfig_UpSource_Channel(tRioStatusCode *
                                                      status);
            unsigned char readConfig_UpSource_Module(tRioStatusCode *
                                                     status);
            bool readConfig_UpSource_AnalogTrigger(tRioStatusCode * status);
            unsigned char readConfig_DownSource_Channel(tRioStatusCode *
                                                        status);
            unsigned char readConfig_DownSource_Module(tRioStatusCode *
                                                       status);
            bool readConfig_DownSource_AnalogTrigger(tRioStatusCode *
                                                     status);
            unsigned char readConfig_IndexSource_Channel(tRioStatusCode *
                                                         status);
            unsigned char readConfig_IndexSource_Module(tRioStatusCode *
                                                        status);
            bool readConfig_IndexSource_AnalogTrigger(tRioStatusCode *
                                                      status);
            ...
            unsigned short readConfig_PulseLengthThreshold(tRioStatusCode *
                                                           status);
            ...
            void writeTimerConfig(tTimerConfig value,
                                  tRioStatusCode * status);
            void writeTimerConfig_StallPeriod(unsigned int value,
                                              tRioStatusCode * status);
            void writeTimerConfig_AverageSize(unsigned char value,
                                              tRioStatusCode * status);
            void writeTimerConfig_UpdateWhenEmpty(bool value,
                                                  tRioStatusCode * status);
            tTimerConfig readTimerConfig(tRioStatusCode * status);
            unsigned int readTimerConfig_StallPeriod(tRioStatusCode *
                                                     status);
            unsigned char readTimerConfig_AverageSize(tRioStatusCode *
                                                      status);
