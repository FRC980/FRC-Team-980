    ...
    namespace n306F586FB5ADD059CDB0429821CA506D
    {
        class tAI:public tSystem
        {
          public:
            ...
            void writeConfig_ScanSize(unsigned char value,
                                      tRioStatusCode * status);
            void writeConfig_ConvertRate(unsigned int value,
                                         tRioStatusCode * status);
            ...
            void writeScanList(unsigned char bitfield_index,
                               unsigned char value,
                               tRioStatusCode * status);
            unsigned char readScanList(unsigned char bitfield_index,
                                       tRioStatusCode * status);

            static const unsigned char kNumAverageBitsElements;
            void writeAverageBits(unsigned char bitfield_index,
                                  unsigned char value,
                                  tRioStatusCode * status);
            unsigned char readAverageBits(unsigned char bitfield_index,
                                          tRioStatusCode * status);

            unsigned int readLoopTiming(tRioStatusCode * status);

            static const unsigned char kNumOversampleBitsElements;
            void writeOversampleBits(unsigned char bitfield_index,
                                     unsigned char value,
                                     tRioStatusCode * status);
            unsigned char readOversampleBits(unsigned char bitfield_index,
                                             tRioStatusCode * status);

            static signed int readOutput(tRioStatusCode * status);

            static void writeReadSelect(tReadSelect value,
                                        tRioStatusCode * status);
            static void writeReadSelect_Channel(unsigned char value,
                                                tRioStatusCode * status);
            static void writeReadSelect_Module(unsigned char value,
                                               tRioStatusCode * status);
            static void writeReadSelect_Averaged(bool value,
                                                 tRioStatusCode * status);
            static tReadSelect readReadSelect(tRioStatusCode * status);
            static unsigned char readReadSelect_Channel(tRioStatusCode *
                                                        status);
            static unsigned char readReadSelect_Module(tRioStatusCode *
                                                       status);
            ...
            signed int readOffset(unsigned char reg_index,
                                  tRioStatusCode * status);

            static const unsigned char kNumLSBWeightRegisters;
            unsigned int readLSBWeight(unsigned char reg_index,
                                       tRioStatusCode * status);
