...
namespace nFPGA
{
    namespace n306F586FB5ADD059CDB0429821CA506D
    {
        ...
        {
          public:
            tAnalogTrigger(unsigned char sys_index,
            ...
            void writeSourceSelect(tSourceSelect value,
                                   tRioStatusCode * status);
            void writeSourceSelect_Channel(unsigned char value,
                                           tRioStatusCode * status);
            void writeSourceSelect_Module(unsigned char value,
                                          tRioStatusCode * status);
            void writeSourceSelect_Averaged(bool value,
                                            tRioStatusCode * status);
            void writeSourceSelect_Filter(bool value,
                                          tRioStatusCode * status);
            void writeSourceSelect_FloatingRollover(bool value,
                                                    tRioStatusCode *
                                                    status);
            void writeSourceSelect_RolloverLimit(signed short value,
                                                 tRioStatusCode * status);
            ...
            signed short readSourceSelect_RolloverLimit(tRioStatusCode *
                                                        status);
            ...
            static tOutput readOutput(unsigned char bitfield_index,
                                      tRioStatusCode * status);
            static bool readOutput_InHysteresis(unsigned char
                                                bitfield_index,
                                                tRioStatusCode * status);
            static bool readOutput_OverLimit(unsigned char bitfield_index,
                                             tRioStatusCode * status);
            static bool readOutput_Rising(unsigned char bitfield_index,
                                          tRioStatusCode * status);
            static bool readOutput_Falling(unsigned char bitfield_index,
                                           tRioStatusCode * status);
