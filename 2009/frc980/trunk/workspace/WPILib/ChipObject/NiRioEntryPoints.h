...
extern "C"
{
    ...
    kNIRIOSRVExportPre void
        kNIRIOSRVCCall NiRioSrv_freeString(char *s) kNIRIOSRVExportPost;

    typedef void (kNIRIOSRVCCall * NiRioSrv_freeStringFn) (char *s);
    ...
    //
    kNIRIOSRVExportPre char *kNIRIOSRVCCall
        NiRioSrv_host_getResourceString(const char *host,
                                        const char *pattern,
                                        tNIRIO_u32 index,
                                        tRioStatusCode *
                                        status) kNIRIOSRVExportPost;

    typedef char *
        (kNIRIOSRVCCall *
         NiRioSrv_host_getResourceStringFn) (const char *host,
                                             const char *pattern,
                                             tNIRIO_u32 index,
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_closeFn) (tRioDeviceHandle hClient,
                                   tRioStatusCode * status);
    ...
    typedef tNIRIO_u32
        (kNIRIOSRVCCall *
         NiRioSrv_device_get32Fn) (tRioDeviceHandle hClient,
                                   tRioDeviceAttr32 attribute,
                                   tRioStatusCode * status);
    ...
    //
    kNIRIOSRVExportPre char *kNIRIOSRVCCall
        NiRioSrv_device_getString(tRioDeviceHandle hClient,
    ...
    typedef char *
        (kNIRIOSRVCCall *
         NiRioSrv_device_getStringFn) (tRioDeviceHandle hClient,
                                       tRioDeviceAttrStr attribute,
                                       tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_set32Fn) (tRioDeviceHandle hClient,
                                   tRioDeviceAttr32 attribute,
                                   tNIRIO_u32 value,
                                   tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_setStringFn) (tRioDeviceHandle hClient,
                                       tRioDeviceAttrStr attribute,
                                       const char *value,
                                       tRioStatusCode * status);
    ...
    kNIRIOSRVExportPre void
        kNIRIOSRVCCall NiRioSrv_device_downloadBegin(tRioDeviceHandle
                                                     hClient,
                                                     tRioStatusCode *
                                                     status)
        kNIRIOSRVExportPost;
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_downloadBeginFn) (tRioDeviceHandle hClient,
                                           tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_downloadEndFn) (tRioDeviceHandle hClient,
                                         tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_configSetFn) (tRioDeviceHandle hClient,
                                       tNIRIO_u32 attribute,
                                       tRioStatusCode * status);
    ...
    //
    kNIRIOSRVExportPre void
        kNIRIOSRVCCall NiRioSrv_device_configAddFifoInputEx(tRioDeviceHandle
                                                            hClient,
                                                            tNIRIO_u32
                                                            channel,
                                                            tNIRIO_u32
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_configAddFifoInputExFn) (tRioDeviceHandle hClient,
                                                  tNIRIO_u32 channel,
    ...
    kNIRIOSRVExportPre void
        kNIRIOSRVCCall
        NiRioSrv_device_configAddFifoOutputEx(tRioDeviceHandle hClient,
                                              tNIRIO_u32 channel,
                                              tNIRIO_u32 baseAddress,
                                              tNIRIO_u32 depthInSamples,
                                              tNIRIO_u32 version,
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_configAddFifoOutputExFn) (tRioDeviceHandle hClient,
                                                   tNIRIO_u32 channel,
                                                   tNIRIO_u32 baseAddress,
                                                   tNIRIO_u32
                                                   depthInSamples,
    ...
    kNIRIOSRVExportPre void
        kNIRIOSRVCCall NiRioSrv_device_fifoConfig(tRioDeviceHandle hClient,
                                                  ...
                                                  status)
        kNIRIOSRVExportPost;
    typedef void (kNIRIOSRVCCall *
                  NiRioSrv_device_fifoConfigFn) (tRioDeviceHandle hClient,
                                                 tNIRIO_u32 channel,
                                                 tNIRIO_u32
                                                 fifoDepthInElements,
                                                 tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_fifoStartFn) (tRioDeviceHandle hClient,
                                       tNIRIO_u32 channel,
                                       tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_fifoStopFn) (tRioDeviceHandle hClient,
                                      tNIRIO_u32 channel,
                                      tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_fifoReadFn) (tRioDeviceHandle hClient,
                                      tNIRIO_u32 channel, tNIRIO_u32 * buf,
                                      tNIRIO_u32 num, tNIRIO_u32 timeout,
                                      tNIRIO_u32 * read,
                                      tNIRIO_u32 * remaining,
                                      tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_fifoWriteFn) (tRioDeviceHandle hClient,
                                       tNIRIO_u32 channel, tNIRIO_u32 * buf,
                                       tNIRIO_u32 num, tNIRIO_u32 timeout,
                                       tNIRIO_u32 * remaining,
                                       tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_fifoStopAllFn) (tRioDeviceHandle hClient,
                                         tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_readBlockFn) (tRioDeviceHandle hClient,
                                       tNIRIO_u32 offset, tNIRIO_u32 repeat,
                                       void *data, tNIRIO_u32 attribute,
                                       tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_writeBlockFn) (tRioDeviceHandle hClient,
                                        tNIRIO_u32 offset,
                                        tNIRIO_u32 repeat, const void *data,
                                        tNIRIO_u32 attribute,
                                        tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_poke64Fn) (tRioDeviceHandle hClient,
                                    tNIRIO_u32 offset, tNIRIO_u64 value,
                                    tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_poke32Fn) (tRioDeviceHandle hClient,
                                    tNIRIO_u32 offset, tNIRIO_u32 value,
                                    tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_poke16Fn) (tRioDeviceHandle hClient,
                                    tNIRIO_u32 offset, tNIRIO_u16 value,
                                    tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_poke8Fn) (tRioDeviceHandle hClient,
                                   tNIRIO_u32 offset, tNIRIO_u8 value,
                                   tRioStatusCode * status);
    ...
    typedef tNIRIO_u64
        (kNIRIOSRVCCall *
         NiRioSrv_device_peek64Fn) (tRioDeviceHandle hClient,
                                    tNIRIO_u32 offset,
                                    tRioStatusCode * status);
    ...
    typedef tNIRIO_u32
        (kNIRIOSRVCCall *
         NiRioSrv_device_peek32Fn) (tRioDeviceHandle hClient,
                                    tNIRIO_u32 offset,
                                    tRioStatusCode * status);
    ...
    typedef tNIRIO_u16
        (kNIRIOSRVCCall *
         NiRioSrv_device_peek16Fn) (tRioDeviceHandle hClient,
                                    tNIRIO_u32 offset,
                                    tRioStatusCode * status);
    ...
    typedef tNIRIO_u8
        (kNIRIOSRVCCall *
         NiRioSrv_device_peek8Fn) (tRioDeviceHandle hClient,
                                   tNIRIO_u32 offset,
                                   tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_eventEnableFn) (tRioDeviceHandle hClient,
                                         tNIRIO_u32 eventID,
                                         tRioStatusCode * status);
    ...
    //
    kNIRIOSRVExportPre void
        kNIRIOSRVCCall NiRioSrv_device_eventDisable(tRioDeviceHandle
                                                    hClient,
                                                    tNIRIO_u32 eventID,
                                                    tRioStatusCode *
                                                    status)
        kNIRIOSRVExportPost;
    typedef void (kNIRIOSRVCCall *
                  NiRioSrv_device_eventDisableFn) (tRioDeviceHandle hClient,
                                                   tNIRIO_u32 eventID,
                                                   tRioStatusCode * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_eventWaitFn) (tRioDeviceHandle hClient,
                                       tNIRIO_u32 eventID,
                                       tNIRIO_u32 timeout,
                                       tRioStatusCode * status);
    ...
    // IRQs:
        ...
        NiRioSrv_device_irqReserve(tRioDeviceHandle hClient,
                                   void **context,
                                   tNIRIO_i32 * status) kNIRIOSRVExportPost;

    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_irqReserveFn) (tRioDeviceHandle hClient,
                                        void **context,
                                        tNIRIO_i32 * status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_device_irqUnreserveFn) (tRioDeviceHandle hClient,
                                          void **context,
                                          tNIRIO_i32 * status);
    ...
    typedef tNIRIO_u32
        (kNIRIOSRVCCall *
         NiRioSrv_device_irqWaitFn) (tRioDeviceHandle hClient,
                                     void **context, tNIRIO_u32 irqs,
                                     tNIRIO_i32 timeout,
                                     tNIRIO_i32 * status);
    ...
    typedef void
        (kNIRIOSRVCCall * NiRioSrv_host_setAliasesFn) (const char *host,
                                                       const char *list,
                                                       tRioStatusCode *
                                                       status);
    ...
    typedef void
        (kNIRIOSRVCCall * NiRioSrv_host_setAliasFn) (const char *host,
                                                     const char *alias,
                                                     const char *resource,
                                                     tRioStatusCode *
                                                     status);
    ...
    typedef tNIRIO_u32
        (kNIRIOSRVCCall * NiRioSrv_host_getAliasesFn) (const char *host,
                                                       tNIRIO_u32 index,
                                                       char **alias,
                                                       char **resource,
                                                       tRioStatusCode *
    ...
    // Client must freeString() any non-NULL return value.
    //
    kNIRIOSRVExportPre char *kNIRIOSRVCCall NiRioSrv_host_resolveAlias(const
                                                                       char
                                                                       *host,
                                                                       const
                                                                       char
    ...
    typedef char *
        (kNIRIOSRVCCall * NiRioSrv_host_resolveAliasFn) (const char *host,
                                                         const char *alias,
                                                         tNIRIO_u32 reverse,
                                                         tRioStatusCode *
                                                         status);
    ...
    typedef void
        (kNIRIOSRVCCall *
         NiRioSrv_host_setDeviceAccessFn) (const char *host,
                                           const char *list,
                                           tRioStatusCode * status);
    ...
    //
    kNIRIOSRVExportPre char *kNIRIOSRVCCall
        NiRioSrv_host_getDeviceAccess(const char *host, tNIRIO_u32 index,
    ...
    typedef char *
        (kNIRIOSRVCCall *
         NiRioSrv_host_getDeviceAccessFn) (const char *host,
                                           tNIRIO_u32 index,
                                           tRioDeviceAccess * access,
                                           tRioStatusCode * status);
    ...
    kNIRIOSRVExportPre char *kNIRIOSRVCCall NiRioSrv_getRecentDevices(const
                                                                      char
                                                                      *host,
                                                                      tNIRIO_u32
                                                                      index,
    ...
    kNIRIOSRVExportPre tNIRIO_u32 kNIRIOSRVCCall NiRioSrv_getRsrcString(tNIRIO_u32 index, char *buffer, tNIRIO_u32 bufferLen, tNIRIO_u32 * stringLen,   // output only
                                                                        tRioStatusCode
                                                                        *
                                                                        status)
        kNIRIOSRVExportPost;
    ...
    kNIRIOSRVExportPre void
        kNIRIOSRVCCall NiRioSrv_device_configAddFifoInput(tRioDeviceHandle
                                                          hClient,
                                                          tNIRIO_u32
                                                          channel,
                                                          tNIRIO_u32
    ...
    kNIRIOSRVExportPre void
        kNIRIOSRVCCall NiRioSrv_device_configAddFifoOutput(tRioDeviceHandle
                                                           hClient,
                                                           tNIRIO_u32
                                                           channel,
                                                           tNIRIO_u32
