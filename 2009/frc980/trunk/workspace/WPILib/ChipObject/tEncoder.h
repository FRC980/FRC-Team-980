    ...
    namespace n306F586FB5ADD059CDB0429821CA506D
    {
        class tEncoder:public tSystem
        {
          public:
            ...
            void writeConfig_ASource_Channel(unsigned char value,
                                             tRioStatusCode * status);
            void writeConfig_ASource_Module(unsigned char value,
                                            tRioStatusCode * status);
            void writeConfig_ASource_AnalogTrigger(bool value,
                                                   tRioStatusCode * status);
            void writeConfig_BSource_Channel(unsigned char value,
                                             tRioStatusCode * status);
            void writeConfig_BSource_Module(unsigned char value,
                                            tRioStatusCode * status);
            void writeConfig_BSource_AnalogTrigger(bool value,
                                                   tRioStatusCode * status);
            ...
            unsigned char readConfig_ASource_Channel(tRioStatusCode *
                                                     status);
            unsigned char readConfig_ASource_Module(tRioStatusCode *
                                                    status);
            bool readConfig_ASource_AnalogTrigger(tRioStatusCode * status);
            unsigned char readConfig_BSource_Channel(tRioStatusCode *
                                                     status);
            unsigned char readConfig_BSource_Module(tRioStatusCode *
                                                    status);
