    ...
    namespace n306F586FB5ADD059CDB0429821CA506D
    {
        class tDIO:public tSystem
        {
          public:
            ...
            void writeFilterSelect(unsigned char bitfield_index,
                                   unsigned char value,
                                   tRioStatusCode * status);
            unsigned char readFilterSelect(unsigned char bitfield_index,
                                           tRioStatusCode * status);

            static const unsigned char kNumFilterPeriodElements;
            void writeFilterPeriod(unsigned char bitfield_index,
                                   unsigned char value,
                                   tRioStatusCode * status);
            unsigned char readFilterPeriod(unsigned char bitfield_index,
                                           tRioStatusCode * status);

            void writeOutputEnable(unsigned short value,
                                   tRioStatusCode * status);
            ...
            unsigned char readI2CStatus_Transaction(tRioStatusCode *
                                                    status);
            bool readI2CStatus_Done(tRioStatusCode * status);

            void writeSlowValue(tSlowValue value, tRioStatusCode * status);
            void writeSlowValue_RelayFwd(unsigned char value,
                                         tRioStatusCode * status);
            void writeSlowValue_RelayRev(unsigned char value,
                                         tRioStatusCode * status);
            void writeSlowValue_I2CHeader(unsigned char value,
                                          tRioStatusCode * status);
            ...
            void writePWMPeriodScale(unsigned char bitfield_index,
                                     unsigned char value,
                                     tRioStatusCode * status);
            unsigned char readPWMPeriodScale(unsigned char bitfield_index,
                                             tRioStatusCode * status);
            ...
            void writePulseLength(unsigned char value,
                                  tRioStatusCode * status);
            unsigned char readPulseLength(tRioStatusCode * status);

            void writeI2CConfig(tI2CConfig value, tRioStatusCode * status);
            void writeI2CConfig_Address(unsigned char value,
                                        tRioStatusCode * status);
            void writeI2CConfig_Register(unsigned char value,
                                         tRioStatusCode * status);
            void writeI2CConfig_DataToSend(unsigned char value,
                                           tRioStatusCode * status);
            void writeI2CConfig_Read(bool value, tRioStatusCode * status);
            void writeI2CConfig_BytesToRead(unsigned char value,
                                            tRioStatusCode * status);
            ...
            unsigned char readI2CConfig_BytesToRead(tRioStatusCode *
                                                    status);

            static unsigned short readLoopTiming(tRioStatusCode * status);

            static void writePWMConfig(tPWMConfig value,
                                       tRioStatusCode * status);
            static void writePWMConfig_Period(unsigned short value,
                                              tRioStatusCode * status);
            static void writePWMConfig_MinHigh(unsigned short value,
                                               tRioStatusCode * status);
            static tPWMConfig readPWMConfig(tRioStatusCode * status);
            static unsigned short readPWMConfig_Period(tRioStatusCode *
                                                       status);
            static unsigned short readPWMConfig_MinHigh(tRioStatusCode *
                                                        status);

            static const unsigned char kNumPWMValueRegisters;
            void writePWMValue(unsigned char reg_index, unsigned char value,
                               tRioStatusCode * status);
            unsigned char readPWMValue(unsigned char reg_index,
                                       tRioStatusCode * status);
