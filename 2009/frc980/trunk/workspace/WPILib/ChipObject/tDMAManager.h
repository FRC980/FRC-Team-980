...
namespace nFPGA
{
    ...
    {
      public:
        tDMAManager(tNIRIO_u32 dmaChannel, tNIRIO_u32 hostBufferSize,
        ...
        void read(tNIRIO_u32 * buf,
                  tNIRIO_u32 num,
                  tNIRIO_u32 timeout,
                  tNIRIO_u32 * read,
                  tNIRIO_u32 * remaining, tRioStatusCode * status);
        void write(tNIRIO_u32 * buf,
                   tNIRIO_u32 num,
                   tNIRIO_u32 timeout,
                   tNIRIO_u32 * remaining, tRioStatusCode * status);
      private:
