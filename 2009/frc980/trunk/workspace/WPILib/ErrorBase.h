 ...
 * ErrorBase is the base class for most objects since it holds the
 * generated error for that object. In addition, there is a single
 * instance of a global error object
 */
class ErrorBase
{
