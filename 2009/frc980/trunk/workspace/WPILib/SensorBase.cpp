...
/**
 * Check that the digital channel number is valid.  Verify that the
 * channel number is one of the legal channel numbers. Channel numbers are
 * 0-based.
 */
...
/**
 * Check that the analog channel number is value.  Verify that the analog
 * channel number is one of the legal channel numbers. Channel numbers are
 * 1-based.
 */
