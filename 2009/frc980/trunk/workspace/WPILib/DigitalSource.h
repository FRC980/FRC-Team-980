 ...
 * quadrature encoder. The source may be either a digital input or an
 * analog input. If the caller just provides a channel, then a digital
 * input will be constructed and freed when finished for the source. The
