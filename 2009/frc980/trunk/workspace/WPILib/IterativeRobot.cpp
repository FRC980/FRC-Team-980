...
IterativeRobot::IterativeRobot()
{
    ...
    // set status for initialization of disabled, autonomous, and teleop
    // code.
 ...
 *
 * The period is set in seconds for the length of time between calls to
 * the periodic functions.  Default period is 0.005 seconds (200Hz
 * iteration loop).
 */
