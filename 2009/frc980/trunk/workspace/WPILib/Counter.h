 ...
 * This is a general purpose class for counting repetitive events. It can
 * return the number of counts, the period of the most recent cycle, and
 * detect when the signal being counted has stopped by supplying a maximum
 * cycle time.
 */
