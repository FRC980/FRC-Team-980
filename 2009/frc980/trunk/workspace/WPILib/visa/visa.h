...
/*- VISA Types --------------------------------------------------------------*/
    ...
    typedef ViStatus(_VI_FUNCH _VI_PTR ViHndlr)
        (ViSession vi, ViEventType eventType, ViEvent event,
         ViAddr userHandle);

/*- Resource Manager Functions and Operations -------------------------------*/

    ViStatus _VI_FUNC viOpenDefaultRM(ViPSession vi);
    ViStatus _VI_FUNC viFindRsrc(ViSession sesn, ViString expr,
...
/*- Resource Template Operations --------------------------------------------*/
    ...
    ViStatus _VI_FUNC viStatusDesc(ViObject vi, ViStatus status,
                                   ViChar _VI_FAR desc[]);
    ViStatus _VI_FUNC viTerminate(ViObject vi, ViUInt16 degree,
                                  ViJobId jobId);
...
/*- Formatted and Buffered I/O Operations -----------------------------------*/
    ...
    ViStatus _VI_FUNCC viSPrintf(ViSession vi, ViPBuf buf,
                                 ViString writeFmt, ...);
    ViStatus _VI_FUNC viVSPrintf(ViSession vi, ViPBuf buf,
                                 ViString writeFmt, ViVAList parms);

    ViStatus _VI_FUNCC viScanf(ViSession vi, ViString readFmt, ...);
    ViStatus _VI_FUNC viVScanf(ViSession vi, ViString readFmt,
                               ViVAList params);
