    ...
    namespace n6F0EA7B88ADB8E3FD4127A39E3502C6D
    {
        ...
        class tInterrupt:public tSystem
        {
          public:
            ...
            void writeConfig_Source_Channel(unsigned char value,
                                            tRioStatusCode * status);
            void writeConfig_Source_Module(unsigned char value,
                                           tRioStatusCode * status);
            void writeConfig_Source_AnalogTrigger(bool value,
                                                  tRioStatusCode * status);
            void writeConfig_RisingEdge(bool value,
                                        tRioStatusCode * status);
            void writeConfig_FallingEdge(bool value,
                                         tRioStatusCode * status);
            void writeConfig_WaitForAck(bool value,
                                        tRioStatusCode * status);
            tConfig readConfig(tRioStatusCode * status);
            unsigned char readConfig_Source_Channel(tRioStatusCode *
                                                    status);
