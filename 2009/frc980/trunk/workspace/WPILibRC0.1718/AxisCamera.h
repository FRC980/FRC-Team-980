...
int  GetImageBlocking(Image * cameraImage, double *timestamp,
...
int  GetImageDataBlocking(char **imageData, int *numBytes,
                          double *timestamp, double lastImageTimestamp);
