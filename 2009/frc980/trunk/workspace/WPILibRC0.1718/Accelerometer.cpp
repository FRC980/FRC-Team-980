 ...
 *
 * The accelerometer is assumed to be in the first analog module in the
 * given analog channel. The constructor allocates desired analog channel.
 */
 ...
 *
 * Make a new instance of the accelerometer given a module and
 * channel. The constructor allocates the desired analog channel from the
 * specified module
 */
 ...
 * Make a new instance of accelerometer given an AnalogChannel. This is
 * particularly useful if the port is going to be read as an analog
 * channel as well as through the Accelerometer class.
 */
 ...
 * acceleration.  The sensitivity varys by accelerometer model. There are
