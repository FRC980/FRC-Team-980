 ...
 *
 * InitServo() assigns defaults for the period multiplier for the servo
 * PWM control signal, as well as the minimum and maximum PWM values
 ...
 *
 * @param channel The PWM channel on the digital module to which the servo
 * is attached.
 */
