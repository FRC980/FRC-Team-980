...
char *GetVisionErrorText(int errorCode)
{
    ...
    case -1074395390:
        {
            errorText =
                "ERR_COLOR_TEMPLATE_IMAGE_LUMINANCE_CONTRAST_TOO_LOW";
            break;
        }
    case -1074395391:
        {
    ...
    case -1074395590:
        {
            errorText =
                "ERR_NIOCR_INVALID_NUMBER_OF_VALID_CHARACTER_POSITIONS";
            break;
        }
    case -1074395591:
        {
    ...
    case -1074395793:
        {
            errorText =
                "ERR_INVALID_OPERATION_ON_COMPACT_SESSION_ATTEMPTED";
            break;
        }
    case -1074395794:
        {
