...
void SetMaxEncoderPeriod(UINT32 aChannel, UINT32 bChannel,
                         double maxPeriod);
...
void SetEncoderDistancePerPulse(UINT32 aChannel, UINT32 bChannel,
...
void SetMaxEncoderPeriod(UINT32 aslot, UINT32 aChannel, UINT32 bslot,
                         UINT32 bChannel, double maxPeriod);
...
bool GetEncoderDirection(UINT32 aslot, UINT32 aChannel, UINT32 bslot,
                         UINT32 bChannel);
double GetEncoderDistance(UINT32 aslot, UINT32 aChannel, UINT32 bslot,
                          UINT32 bChannel);
double GetEncoderRate(UINT32 aslot, UINT32 aChannel, UINT32 bslot,
                      UINT32 bChannel);
void SetMinEncoderRate(UINT32 aslot, UINT32 aChannel, UINT32 bslot,
                       UINT32 bChannel, double minRate);
void SetEncoderDistancePerPulse(UINT32 aslot, UINT32 aChannel, UINT32 bslot,
                                UINT32 bChannel, double distancePerPulse);
void SetEncoderReverseDirection(UINT32 aslot, UINT32 aChannel, UINT32 bslot,
                                UINT32 bChannel, bool reversedDirection);
